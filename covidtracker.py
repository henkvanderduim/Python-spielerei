...
def showdata():
    ...
    try:
        ...
        confirmed_patch = mp.Patch(color="green", label="confirmed")
        recovered_patch = mp.Patch(color="red", label="recovered")
        active_patch = mp.Patch(color="blue", label="active")
        deaths_patch = mp.Patch(color="black", label="deaths")
        # plotting the scale on graph using legend()
        plt.legend(
            handles=[confirmed_patch, recovered_patch, active_patch, deaths_patch]
        )
